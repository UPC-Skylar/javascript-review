...
export class ProductId {
    ...
    //Se debe generar un Product UUID aleatorio porq no tengo el bounded-context que maneja los productos
    ...
    /**
     * Compares this ProductId instance with another ProductId instane for equality
