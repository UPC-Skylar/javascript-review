...
/**
 * Represents a supplier aggregate in the SCM domain bounded context.
 */
export class Supplier {
     ...
     * @param {string|null}         params.contactEmail - The contact email of the supplier. Can be null.
     * @param {Money|null}          params.lastOrderTotalPrice - The total price of the last order. Can be null.
     */
    constructor({id, name, contactEmail = null, lastOrderTotalPrice = null}) {
        ...
        if (lastOrderTotalPrice !== null && !(lastOrderTotalPrice instanceof Money))
            throw new ValidationError('lastOrderTotalPrice must be an instance of Money or null');
        this._id = id;
        this._name = name;
     ...
     * @returns {string|null} The contact email of the supplier, or null if not provided.
     */
    get contactEmail() { return this._contactEmail; }

    /**
     * Returns the total price of the last order placed with the supplier.
     * @returns {Money|null} The total price of the last order made to the supplier, or null if not provided.
     */
